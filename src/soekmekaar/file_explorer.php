<?php
    ...
    if(isset($_GET['floorplan']) && isset($_GET['name'])){
        $name = $_GET['name'];
    }
    else {
...
<body class="body-2">
    ...
    <button class="top-btn" onclick="toTop()">
    ...
    <script>
        ...
        function view(e){
            window.open("floor-plan/" + e, "_blank");
        ...
        function choose(name, plan){
            name2 = "<?php echo $name; ?>";
            window.location.href = "Resources/functions/save_changes.php?id=" + name2 + "&floorplan=" + plan;
        }
    </script>
